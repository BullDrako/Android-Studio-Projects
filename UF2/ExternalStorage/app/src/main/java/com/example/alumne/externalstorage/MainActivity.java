package com.example.alumne.externalstorage;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        buttonCreateStorage.setOnClickListener(new View.OnClickListener() {
        ...
        buttonCheckStorage.setOnClickListener(new View.OnClickListener() {
        ...
        buttonExternalMediaDir.setOnClickListener(new View.OnClickListener() {
